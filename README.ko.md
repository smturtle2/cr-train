...
| `train_crop_size` | `int \| None` | `None` | collate 직전 train batch에 이 크기의 random square crop을 적용. |
| `train_random_flip` | `bool` | `False` | train batch에 vertical/horizontal flip을 독립적으로 무작위 적용. |
| `train_random_rot90` | `bool` | `False` | train batch에 `0/90/180/270`도 회전을 무작위 적용. |
